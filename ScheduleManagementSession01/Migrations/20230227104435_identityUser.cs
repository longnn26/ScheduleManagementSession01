    ...
    public partial class identityUser : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    BookingBeforeDate = table.Column<int>(type: "integer", nullable: false),
                    BookingAfterDate = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Day_WorkingCalendar_WorkingCalendarId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServicesWorkingCalendar", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServicesWorkingCalendar_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServicesWorkingCalendar_WorkingCalendar_WorkingCalendarId",
                        column: x => x.WorkingCalendarId,
                        principalTable: "WorkingCalendar",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServicesWorkingCalendar_ServiceId",
                table: "ServicesWorkingCalendar",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_ServicesWorkingCalendar_WorkingCalendarId",
                table: "ServicesWorkingCalendar",
                column: "WorkingCalendarId");
        }
